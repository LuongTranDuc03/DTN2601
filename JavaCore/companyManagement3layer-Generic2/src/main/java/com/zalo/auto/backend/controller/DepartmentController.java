...
public class DepartmentController {
    ...
    public boolean checkIfNameExists(String name) { return departmentSevice.checkIfExistName(name); }

    public String importDepartmentToCSV(String pahtName) throws FileNotFoundException { // Trả về String import thành công or thất bại
        return departmentSevice.importDepartmentToCSV(pahtName);
    }
}
