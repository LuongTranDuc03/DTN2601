...
public class DepartmentFunction {
    ...
    public void menu() throws FileNotFoundException {
        while (true) {
            ...
            System.out.println("8. Import dữ liệu từ file .csv");
    ...
    private void importFile() throws FileNotFoundException {
        ...
        String pahtName = scanner.nextLine();
        String result = departmentController.importDepartmentToCSV(pahtName);
